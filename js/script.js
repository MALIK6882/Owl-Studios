...
const config = {
    serverInfo: {
        ...
        serverName: "OWL STUDIOS", /*Server name*/
        serverIp: "play.owl.net:19132", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        ...
        leaders: [
            {
                inGameName: "McDev",
                rank: "Founder",
                skinUrlOrPathToFile: "e3RleHR1cmVzOntTS0lOOnt1cmw6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTQyZWJiZjg5NTBkZTk2ZTlhOGRhZWMzODJkM2JhYTdhMGUyMDEwMGQxMjhiYTgxNzEwMTE2YjJmODVhZjk4NCJ9fX0",
            ...
            },
            {
                inGameName: "Rasyad",
                rank: "Founder",
                skinUrlOrPathToFile: "../images/rasyad.png",
                rankColor: "rgba(255, 3, 3, 1)"
            },
            {
                inGameName: "Yudha",
                rank: "Manager",
                skinUrlOrPathToFile: "../images/yudha.png",
                rankColor: ""
            }
        ],
        developers: [
            ...
            },
            {
                inGameName: "Onez",
                rank: "Setup Master",
                skinUrlOrPathToFile: "../images/onez.png",
                rankColor: ""
            },
            {
                inGameName: "NakataZ",
                rank: "PM Master",
                skinUrlOrPathToFile: "../images/nakata.png",
                rankColor: ""
            },
            {
                inGameName: "Vinz",
                rank: "Plugins Master",
                skinUrlOrPathToFile: "../images/vinz.png",
                rankColor: ""
            }
        ],
        helpers: [
            {
                inGameName: "Abella",
                rank: "Goddess",
                skinUrlOrPathToFile: "abella.png",
                rankColor: "rgba(255, 3, 3, 1)"
            },
            {
                inGameName: "Tiara",
                rank: "Helper++",
                skinUrlOrPathToFile: "../images/tiara.png",
                rankColor:"rgba(255, 124, 124, 0.5)"
            },
            {
                inGameName: "Rebi",
                rank: "Manager 2",
                skinUrlOrPathToFile: "../images/rebi.png",
                rankColor: "rgba(255, 124, 124, 0.5)"
            },
            {
                inGameName: "We Are Hiring!",
                rank: "Helper",
                skinUrlOrPathToFile: "../images/unknown.png",
                rankColor: ""
            },
            {
                inGameName: "We Are Hiring!",
        ...
        builders: [
            {
                inGameName: "Matrix",
                rank: "Builder++",
                skinUrlOrPathToFile: "../images/matrix.png",
                rankColor: ""
            },
            {
                inGameName: "Gerad",
                rank: "Builder++",
                skinUrlOrPathToFile: "../images/gerad.png",
                rankColor: ""
            },
            {
                inGameName: "Steve404",
                rank: "Builder+",
                skinUrlOrPathToFile: "../images/steve404.png",
                rankColor: ""
            },
            {
                inGameName: "We Are Hiring!",
